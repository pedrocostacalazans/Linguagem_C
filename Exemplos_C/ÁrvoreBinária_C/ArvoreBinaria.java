...
class Tree {
  ...
  public boolean remover(long v) {
    ...
    // Se possui mais de um filho, se for um avô ou outro grau maior de parentesco
      ...
      // Usando sucessor que seria o Nó mais a esquerda da subarvore a direita do No que deseja-se
      // remover
  ...
  public No no_sucessor(No apaga) { // O parametro é a referencia para o No que deseja-se apagar
    ...
    // *********************************************************************************
    if (sucessor
        != apaga.dir) { // se sucessor nao é o filho a direita do Nó que deverá ser eliminado
      paidosucessor.esq =
          sucessor.dir; // pai herda os filhos do sucessor que sempre serão a direita
  ...
  public int altura(No atual) {
    if (atual == null || (atual.esq == null && atual.dir == null)) return 0;
    else {
      if (altura(atual.esq) > altura(atual.dir)) return (1 + altura(atual.esq));
      else return (1 + altura(atual.dir));
    }
  }
        ...
        case 2:
          {
            System.out.print("\n Informe o valor (long) -> ");
            x = le.nextLong();
            if (!arv.remover(x)) System.out.print("\n Valor nao encontrado!");
            ;
            break;
          }
        case 3:
          {
            System.out.print("\n Informe o valor (long) -> ");
            x = le.nextLong();
            if (arv.buscar(x) != null) System.out.print("\n Valor Encontrado");
